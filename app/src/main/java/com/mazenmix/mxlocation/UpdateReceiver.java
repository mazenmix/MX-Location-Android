...
public class UpdateReceiver extends BroadcastReceiver {
    ...
    @Override public void onReceive(Context context, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationChannel c = new NotificationChannel(CHANNEL, "MX Location Updates",
        ...
        Notification n = b.setSmallIcon(R.drawable.ic_stat_location)
                ...
                .setContentText("Update installed. Tap to open the new version.")
                .setContentIntent(pi)
                .setAutoCancel(true)
                .build();
        ((NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE)).notify(7091, n);
    }
}
